...
namespace WebRtc.NET.Demo
{
    public partial class MainForm : Form
    {
            ...
            try
            {
                ...
                
                {
                    // render
                    {
                        ...
                        {
                            #region -- native webrtc mp4 capture --

                            //set internals.h #define VIDEO_CAPTURE 1

                            foreach (var s in webSocketServer.Streams)
                            {
                                s.Value.WebRtc.CaptureVideo(videoFile);
                                unsafe
                                {
        ...
        internal string videoFile = "D:/workspaces/workWebRTC/WebRTCNative_3/WebRtc.NET/video/chrome.mp4";
