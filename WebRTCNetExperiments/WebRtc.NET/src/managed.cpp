...
/////////////////////////////////////////////////////////////////////////////////////////////////////
			System::Byte* VideoCapturerBuffer()
			{
#if VIDEO_CAPTURE
				return nullptr;
#else
				throw gcnew System::NotImplementedException("set internals.h #define VIDEO_CAPTURE 1");
#endif			
			}

			void VideoCapturerSize(Int32% w, Int32% h)
			{
#if VIDEO_CAPTURE
			...
			void CaptureVideo(String ^ path)
			{
#if VIDEO_CAPTURE
				cd->CaptureVideo(marshal_as<std::string>(path));
#else
				throw gcnew System::NotImplementedException("set internals.h #define VIDEO_CAPTURE 1");
#endif
			}
